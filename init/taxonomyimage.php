...
add_action( 'costume_tax_add_form_fields', 'add_custom_taxonomy_image', 10, 2 );
...
add_action( 'created_costume_tax', 'save_custom_taxonomy_image', 10, 2 );
...
add_action( 'costume_tax_edit_form_fields', 'update_custom_taxonomy_image', 10, 2 );
...
add_action( 'edited_costume_tax', 'updated_custom_taxonomy_image', 10, 2 );
...
add_filter( 'manage_edit-costume_tax_columns', 'display_custom_taxonomy_image_column_heading' ); 
...
add_action( 'manage_costume_tax_custom_column', 'display_custom_taxonomy_image_column_value' , 10, 3); 
